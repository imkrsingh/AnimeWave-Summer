...
import { Compass, Flame, Shield, Sun, Sparkles, MapPin, Users, Activity } from "lucide-react";
...
const CHRONICLES_DATA = [
  ...
  },
  {
    ...
    glowText: "text-red-500 dark:text-red-450 neon:text-rose-455"
  },
  {
    id: 4,
...
export default function SummerChronicles() {
  return (
    <section id="story" className="py-20 bg-sky-100 dark:bg-slate-950 neon:bg-[#090014] relative overflow-hidden transition-colors duration-300 transform-gpu">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="hidden md:block absolute left-1/2 top-2 bottom-2 w-[4px] bg-gradient-to-b from-sky-400 via-pink-500 dark:via-fuchsia-500 neon:via-cyan-400 to-orange-500 rounded-full transform -translate-x-1/2 z-10 pointer-events-none opacity-40 dark:opacity-25 neon:opacity-60 shadow-[0_0_10px_rgba(34,211,238,0.2)]"></div>

          {/* Timeline Nodes */}
          <div className="space-y-8 md:space-y-6">
            {CHRONICLES_DATA.map((arc, index) => {
              const Icon = arc.icon;
                ...
                <div key={arc.id} className="relative flex flex-col md:flex-row items-stretch z-10 group">
                  ...
                  {isLeft ? (
                    <div className="w-full md:w-1/2 pr-0 md:mr-auto pl-6 md:pl-0 flex md:justify-end">
                      ...
                      >
                        {/* Compact watermarked background icon */}
                        ...
                        <div className="relative z-10 flex flex-col justify-between h-full">
                          ...
                          {/* Neat micro pills at the bottom */}
                    ...
                    /* Spacer for the left side when right is active */
                    <div className="hidden md:block w-1/2"></div>
                  )}

                  {/* RIGHT ALIGNED COMPACT ITEM */}
                  {!isLeft ? (
                    ...
                    /* Spacer for the right side when left is active */
                    <div className="hidden md:block w-1/2"></div>
                  )}
                </div>
              );
